<?php
	...
	/**
	 * Template part for displaying header 2
	 *
...
<div class="site-header-wrapper header-2 row">
	...
	<div class="site-navigation">
		...
		<nav class="main-navigation">
			<?php wp_nav_menu( array( 'theme_location' => 'menu-left', 'menu_id' => 'desktop-site-navigation-left', 'menu_class' => 'nav-menu-left' ) ); ?>
		</nav><!-- #site-navigation -->

		<nav class="main-navigation">
			<?php wp_nav_menu( array( 'theme_location' => 'menu-right', 'menu_id' => 'desktop-site-navigation-right', 'menu_class' => 'nav-menu-right' ) ); ?>
		</nav><!-- #site-navigation -->
