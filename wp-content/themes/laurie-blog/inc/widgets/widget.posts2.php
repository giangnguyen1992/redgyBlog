...
add_action( 'widgets_init', create_function( '', 'register_widget( "laurie_blog_posts_list_widget_2" );' ) );
class Laurie_Blog_Posts_List_Widget_2 extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'laurie_blog_posts_list_widget_2', // Base ID
			esc_html__( 'Laurie Blog - Posts List #2', 'laurie-blog' ), // Name
				...
				<?php 
					...
					while ( $laurie_blog_query->have_posts() ) : $laurie_blog_query->the_post();
						...
						<div class="post-thumb">
							<h1 class="post-number"><?php echo intval($postNumber++); ?></h1>
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'laurie-blog-post-widget-thumb-2' ); ?></a>
						</div>
						<?php endif; ?>
