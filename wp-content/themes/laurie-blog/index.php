...
<?php
	...
	// posts style
	$posts_style = laurie_blog_get_theme_mod( 'posts_style', 'post-s1' );
	...
	$laurie_blog_first_query = new WP_Query( $argsFirst ); 
	...
	?>
		...
		if ( laurie_blog_get_theme_mod( 'posts_style', 'post-s1' ) == 'post-s3' || laurie_blog_get_theme_mod( 'posts_style', 'post-s1' ) == 'post-s4' ) : ?>
		...
		<?php endif; ?>
			...
			<?php	
				...
				while ( $laurie_blog_query->have_posts() ) : $laurie_blog_query->the_post();
					...
					$layout = laurie_blog_get_theme_mod( 'posts_style', 'post-s1' );
			...
			<?php if ( laurie_blog_get_theme_mod( 'posts_style', 'post-s1' ) == 'post-s3' || laurie_blog_get_theme_mod( 'posts_style', 'post-s1' ) == 'post-s4' ) : ?>
